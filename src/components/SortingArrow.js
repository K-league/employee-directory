...
function SortingArrow({headingMatches, order}) {
    if(!headingMatches) {
    ...
    if(order !== "ascend") {
        return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down" viewBox="0 0 16 16">
